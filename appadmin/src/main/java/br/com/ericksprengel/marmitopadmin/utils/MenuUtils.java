package br.com.ericksprengel.marmitopadmin.utils;
...
import br.com.ericksprengel.marmitopadmin.data.MtopMenuItem;
...
public class MenuUtils {
    ...
    public static void createMenuOfTheDay() {
        ...
        createMtopMenuItem("Strogonoff de Carne", "Arroz e batata palha (feijão opcional)", options);
